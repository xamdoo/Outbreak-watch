...
function Signup(){
    ...
    return(
            ...
            <div className="flex border-2 rounded-lg shadow-2xl bg-slate-50 m-auto mt-5 w-3/4 h-5/6 ">
                <div className="p-20 pt-2">
                    <h1 className='font-bold text-2xl mb-5 mt-3'>Welcome to Outbreak Watch</h1>
                    ...
                    <form>
                        <div className='m-2 ml-20 mb-3 relative'>
                            ...
                            <input type="text" placeholder='First Name' className=' bg-slate-50 border-b-2 border-red-900 focus:text-black outline-none pl-7'
                            onChange={(e)=> setInputs({...inputs, firstName:e.target.value})}/>
                        </div>
                        <div className='m-2 ml-20 mb-3 relative'>
                            <BsPersonFill className='absolute text-gray-500 top-1 left-1'/>
                            <input type="text" placeholder='Second Name' className=' bg-slate-50 border-b-2 border-red-900 focus:text-black outline-none pl-7'
                            onChange={(e)=> setInputs({...inputs, secondName:e.target.value})}/>
                        </div>
