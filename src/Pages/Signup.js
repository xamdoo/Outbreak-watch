            ...
            <div className="flex border-2 rounded-lg shadow-2xl bg-slate-50 w-4/6 h-5/6 m-auto mt-5">
                <div className="p-20 pt-2">
                    ...
                    <form>
                        ...
                        <button type='submit' className='border-2 rounded-md px-2 py-0.5 mt-2 ml-28 text-white bg-red-900  hover:bg-white hover:text-red-900 hover:border-red-900'>Create Account</button>
                    </form>
                    <div className='mt-5'>
