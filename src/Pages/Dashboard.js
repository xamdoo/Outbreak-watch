...
function Dashboard(){
    ...
    return(
        <div className="bg-gradient-to-bl from-red-50 to-slate-200 h-screen">
            <div className="m-auto w-3/5">
                ...
                <div className="flex space-x-2 pb-4">
                    ...
                    <button className="flex-1 border border-blue-500 p-3 text-blue-500 rounded-md" onClick={handleOnLogOut}>Logout</button>
